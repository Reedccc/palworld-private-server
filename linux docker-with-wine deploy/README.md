...
docker save -o   pserver-docker-wine:latest

docker save -o   pserver-docker-tool:latest

## 本地文件导入

**下载包并上传到服务器**

palworld-server-docker.tar

palworld-manage-tool-docker.tar

**导入镜像**

docker load -i palworld-server-docker.tar

docker load -i palworld-manage-tool-docker.tar
...
![](https://github.com/Reedccc/palworld-private-server/blob/main/images/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20260108110606_219_205.png)



原因是配置不正确，需要修改配置文件 **/path/to/pserver/palworld/Config/WindowsServer/PalWorldSettings.ini**。

如果想进一步自定义配置，也需要自行修改配置文件。

注意这个配置文件在初次启动后才会生成。 

docker compose down

vim /path/to/pserver/palworld/Config/WindowsServer/PalWorldSettings.ini
...
![](https://github.com/Reedccc/palworld-private-server/blob/main/images/%E6%9C%8D%E5%8A%A1%E7%AB%AF%E5%8F%82%E6%95%B0.png)
